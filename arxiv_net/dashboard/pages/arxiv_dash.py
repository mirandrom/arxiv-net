                        ...
                        children=[
                            dcc.Loading(
                                ...
                                children=[
                                    html.Ul(
                                        children=[
                                            html.Li(id=f'paper-placeholder-{i}', className='paper-placeholder')
                                            for i in
...
def highlight_selected_paper(*args):
    classnames = ['paper-placeholder' for paper in range(DASH.feed.display_size - 1)]
...
def feed2(*args):
    ...
    print("Selected: ", DASH.feed.selected)
